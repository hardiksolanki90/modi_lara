...
<div class="con">
  <div class="_tw card">
    ...
    <div class="_tw_w card-body">
      <table class="table table-striped _ft" id="table_email">
        <thead>
          <tr>
            <th filter="id">ID</th>
            <th filter="subject">Subject</th>
            <th filter="component.name">Component</th>
        ...
        <tbody class="m-datatable__body">
          @include('email/_partials/list-only-email')
        </tbody>
      </table>
      <div class="links" table="table_email">
        {{ $obj->links() }}
      </div>
